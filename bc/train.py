...
class WorkspaceIL:
	...
	def save_snapshot(self):
		...
		# keys_to_save = ['agent', 'timer', '_global_step', 
	...
	def load_snapshot(self, snapshot, encoder_only=False):
		with snapshot.open('rb') as f:
			payload = torch.load(f)
		# self.agent.load_snapshot(payload['agent'], encoder_only)
		agent_payload = {}
